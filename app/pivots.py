...
def render_pivot_table(pivot_data, selected_metrics, title, table_id="pivot"):
    ...
    # App column - 150px, frozen, with filter/sort
    gb.configure_column(
        "App",
        pinned="left",
        width=150,
    ...
    # Plan column - 150px, frozen, with filter/sort
    gb.configure_column(
        "Plan",
        pinned="left",
        width=150,
    ...
    # Metric column - 180px, frozen, with filter/sort
    gb.configure_column(
        "Metric",
        pinned="left",
        width=180,
    ...
    # Trend column - 180px, frozen, NO filter/sort
    gb.configure_column(
        "Trend",
        pinned="left",
        width=180,
    ...
    # Date columns - 100px each, NO filter/sort
