...
FIXED: Simplified HTML rendering
"""
...
def render_login_page():
    ...
    # Subtitle
    st.markdown(
        f'<p style="text-align:center;color:{colors["text_secondary"]};font-size:14px;margin:0 0 40px 0;">Sign in to access your dashboards</p>',
