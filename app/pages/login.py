...
Full screen layout with Variant logo
"""
...
def render_login_page():
    ...
    # Centered content
    st.markdown(f'<div style="max-width: 400px; margin: 0 auto; padding: 40px 20px;">', unsafe_allow_html=True)
    ...
    # Subtitle
    st.markdown(f'''
    <p style="text-align: center; color: {colors['text_secondary']}; font-size: 14px; margin: 0 0 40px 0;">
    ...
    with col2:
        ...
        <div style="
            ...
            border: 1px solid {colors['border']};
        ">
            <p style="font-size: 12px; color: {colors['text_secondary']}; margin: 0;">
